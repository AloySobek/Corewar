...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   cw_game_essences_init.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: vrichese <vrichese@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/30 16:39:29 by vrichese          #+#    #+#             */
/*   Updated: 2019/11/09 17:34:49 by vrichese         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		cw_process_obj_init(t_corewar *p_game_instance)
{
	...
	//p_game_instance->p_arena_obj->p_winner = p_game_instance->p_scheduler->p_process_obj->p_owner;
}
...
static void		cw_player_obj_init(t_corewar *p_game_instance, int argc, char **argv)
{
	...
	while (++iter < argc)
		if (*(argv[iter]) == CW_KEY)
		{
			...
			if (p_game_instance->cycle_dump || p_game_instance->verbose || p_game_instance->starting_cycle || p_game_instance->custom_id)
				++iter;
		}
...
{
	p_game_instance->cw_process_obj_init	= cw_process_obj_init;
