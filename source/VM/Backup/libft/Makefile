...
SRC		= $(addprefix $(SRCDIR)/, ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
		...
		ft_strsub.c ft_strtrim.c ft_tolower.c ft_toupper.c ft_lstadd.c ft_strcrop.c \
		ft_lstdel.c ft_lstdelone.c ft_lstiter.c ft_lstnew.c ft_lstmap.c ft_strcut.c)
