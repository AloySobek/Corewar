...
/*   Updated: 2019/11/04 20:58:53 by vrichese         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		cw_main_checking(t_corewar *p_game_instance)
{
	...
	tmp = p_game_instance->p_scheduler->p_waiting_queue->p_current_carriage->p_prev;
	while (p_game_instance->p_scheduler->p_waiting_queue->p_current_carriage != tmp)
	{
		if (p_game_instance->p_arena_obj->cycle_to_die <= (p_game_instance->p_arena_obj->cycle_amount - p_game_instance->p_scheduler->p_waiting_queue->p_current_carriage->last_speak_cycle) || p_game_instance->p_arena_obj->cycle_to_die <= 0)
			p_game_instance->p_scheduler->p_waiting_queue->cw_dequeue(p_game_instance->p_scheduler->p_waiting_queue, NULL);
		else
			p_game_instance->p_scheduler->p_waiting_queue->cw_rotate(p_game_instance->p_scheduler->p_waiting_queue);
	}
	if (p_game_instance->p_arena_obj->cycle_to_die <= (p_game_instance->p_arena_obj->cycle_amount - p_game_instance->p_scheduler->p_waiting_queue->p_current_carriage->last_speak_cycle) || p_game_instance->p_arena_obj->cycle_to_die <= 0)
		p_game_instance->p_scheduler->p_waiting_queue->cw_dequeue(p_game_instance->p_scheduler->p_waiting_queue, NULL);
...
static void		cw_start_game(t_corewar *p_game_instance)
{
	...
	{
		if (p_game_instance->p_arena_obj->cycle_amount == 2180)
		{
		...
		while (p_game_instance->p_scheduler->p_waiting_queue->p_current_carriage->nearest_cycle == p_game_instance->p_arena_obj->cycle_amount)
		{
			...
			p_game_instance->p_scheduler->p_waiting_queue->cw_quant_enqueue(p_game_instance->p_scheduler->p_waiting_queue, p_game_instance->p_carriage_obj);
		}
	}
}
